...
The request body sends the Settings Key as:
...
The one-time Settings Key is not saved.

## Security note

Do not commit code-signing certificates, private keys, Settings Keys, or build secrets to this repository.
